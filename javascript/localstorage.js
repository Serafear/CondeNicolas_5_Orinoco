...
if (localStorage.getItem("cartInfo") != null) {
  document.getElementById("cartContain").innerHTML = orders.map(
    (order) =>
      ` 
  ...
  btnToContact.onclick = () => {
    ...
    cartForm.addEventListener("submit", (e) => {
      ...
      panier.products = orders.map((product) => {
        return product.product_id;
      });

      panier.contact = {
        firstName: document.getElementById("fname")
          .value /*pour que l'élément s'affiche dans lapage thankyou, le .value est indispensable . Si jamais ça ne marche pas, essayer de mettre firstName entre guillemets */,
